<div id="content">
    ...
    <div class="heading-buttons">
        ...
        <div class="buttons pull-right">
            <a href="/admin/tadoonote/create" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i>Create Note</a>
        </div>
        ...
        <div class="widget widget-gray widget-body-white">
            ...
            $var = ($paging[3] != '0')  ? ($paging[3]+1) : 1;
                  ...
                  foreach($paging[0]->result() as  $rows ) : ?>
                    <tr class="selectable" id="listItem_<?php echo $rows->tadoo_note_id; ?>" >
                        <td class="center"><?php echo $rows->tadoo_note_id;; ?></td>
